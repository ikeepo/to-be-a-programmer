# 协调层Agreement
## 原则
协调层 (Agreement) 的核心：性数传递 (Gender and Number Agreement Propagation).

| 原则名称 (Principle) | 中文名称 | 逻辑定义 (Logic Definition) | 典型实例 (Example) |
| :--- | :--- | :--- | :--- |
| **Noun-Centric Propagation** | 名词中心传递 | 名词决定冠词、形容词、代词的性与数。 | *La grande table blanche.* |
