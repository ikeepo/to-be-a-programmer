# Day 2
## Plan
There is no way to finished the schedule defined yesterday, I need to take care of my child.

There are still many grammar rules and grammar points that I don't understand, so I need to set aside five days to brush up on my basic grammar knowledge.
